public class ListaDinamicaPrestamo {
    ...
    public void encabezadoTabla(){
        System.out.println("_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=__=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_=_");

        System.out.print(String.format("%1$-10s", "Clave"));
        System.out.print(String.format("%1$-17s", "Apellido"));
        System.out.print(String.format("%1$-17s", "Nombre"));
        System.out.print(String.format("%1$-20s", "Cantidad prestada"));
        System.out.print(String.format("%1$-15s", "Porcentaje"));
        System.out.print(String.format("%1$-17s", "Semanas a pagar"));
        System.out.print(String.format("%1$-10s", "Cantidad total"));
        System.out.println("--------------------------------------------------------------------------------------------------------------");
    }
    ...
    public void filaTabla(Prestamo prestamo){
        System.out.print(String.format("%1$-10s", prestamo.getClave()));
        System.out.print(String.format("%1$-17s", prestamo.getNombre()));
        System.out.print(String.format("%1$-17s", prestamo.getApellido()));
        System.out.print(String.format("%1$-20s", prestamo.getPrestamo()));
        System.out.print(String.format("%1$-15s", prestamo.getPorcentaje()));
        System.out.print(String.format("%1$-17s", prestamo.getSemana()));
        System.out.println(String.format("%1$-10s", prestamo.PrestamoTotal()));
    ...
    ListaDinamicaPrestamo encontrados = new ListaDinamicaPrestamo();
        iterador = primero.getEnlace();
        while (iterador != null) {
            if ((iterador.getPrestamo().getNombre()).compareTo(buscado) == 0) {
